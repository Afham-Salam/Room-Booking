  ...
  return (
    <>
      <div className="h-screen">
        <div className="w-full p-5 mt-3 border-2 border-gray-200 shadow-lg flex flex-col md:flex-row md:justify-between md:items-center gap-5">
          {/* Room Image */}
          <img className="w-full md:w-60 object-cover" src={RoomImage} alt="Room" />

          {/* Room Details */}
          <div className="grid grid-rows-3 gap-12 lg:gap-x-96 md:grid-cols-2 md:gap-x-12  ">
            <p className="text-left md:text-left">Room Name</p>
            <p className="text-left md:text-left flex  md:justify-start gap-2 sm:w-full ">
            ...
            <p className="text-left md:text-left">Features</p>
