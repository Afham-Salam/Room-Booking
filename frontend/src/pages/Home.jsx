      ...
      <section>
        <div class="flex justify-center relative mt-5 lg:mt-[-50px] md:mt-[-40px]">
          <div class="flex flex-col md:flex-row lg:flex-row items-center px-4 md:px-8 lg:px-14 shadow-2xl bg-white h-auto lg:h-[130px] w-full md:w-[90%] lg:w-[70%] rounded-lg p-4 z-50">
              ...
              {roomDetails.map((item) => (
                <div class="flex items-center gap-4 w-full md:w-auto">
                  <div class="flex flex-col gap-2">
                    ...
                    <p class="text-[17px] text-black font-bold">0</p>
                  </div>
                </div>
              ))}
            ...
            <button className="bg-[#2A9E00] text-white py-2 px-10 rounded-sm hover:bg-[#238200] active:bg-[#1E6E00] focus:ring-2 focus:ring-offset-2 focus:ring-[#2A9E00] transition duration-200">
              Book&nbsp;Now
            </button>
          </div>
        </div>
